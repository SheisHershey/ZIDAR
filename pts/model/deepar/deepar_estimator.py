...
class DeepAREstimator(PyTorchEstimator):
    ...
    def __init__(
        ...
        num_layers: int = 2,  #!! 非零预测模块的RNN层数
        num_cells: int = 40,   #!! 非零预测模块的RNN维数
        num_layers2: int = 2, #!! 状态预测模块的RNN层数
        num_cells2: int = 40, #!! 状态预测模块的RNN维数
        cell_type: str = "LSTM",
        ...
        distr_output2: DistributionOutput = StudentTOutput(),
        distr_output3: DistributionOutput = StudentTOutput(),
        scaling: bool = True,
        ...
        self.distr_output2 = distr_output2
        self.distr_output2.dtype = dtype
        self.distr_output3 = distr_output3
        self.distr_output3.dtype = dtype
        ...
        self.history_length = self.context_length + max(self.lags_seq) #history_length的定义
    ...
    def create_training_network(self, device: torch.device) -> DeepARTrainingNetwork:
        return DeepARTrainingNetwork(
            ...
            distr_output2=self.distr_output2, #!!
            distr_output3=self.distr_output3,
    ...
    def create_predictor(
        ...
        return PyTorchPredictor( #使用prediction_net = DeepARPredictionNetwork，返回一个PytorchPredictor
