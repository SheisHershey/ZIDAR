...
def generate_pts_m5_dataset(
    ...
    cal_path = f"E:\ZIP-DeepAR代码\m5-forecasting-accuracy/calendar.csv"
    sales_path = f"E:\ZIP-DeepAR代码\m5-forecasting-accuracy/sales_train_validation.csv"
    sales_test_path = f"E:\ZIP-DeepAR代码\m5-forecasting-accuracy/sales_train_evaluation.csv"
    sell_prices_path = f"E:\ZIP-DeepAR代码\m5-forecasting-accuracy/sell_prices.csv"
    ...
    if not os.path.exists(cal_path) or not os.path.exists(sales_path):
        raise RuntimeError(
            ...
            f"After you have done that, please copy the files into E:\ZIP-DeepAR代码\m5-forecasting-accuracy."
        )
